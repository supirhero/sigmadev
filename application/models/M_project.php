...
class M_project extends CI_Model {
    ...
    function getUsersProject($id) {
        return $this->db->query("SELECT   distinct project_id, project_name, project_complete,
            project_status, project_desc, created_by
       FROM (SELECT a.user_id, a.user_name, c.project_id, c.project_name,
                    c.project_complete, c.project_status, c.project_desc,
                    c.created_by
               FROM USERS a INNER JOIN resource_pool b ON a.user_id =
                                                                     b.user_id
                    INNER JOIN projects c ON b.project_id = c.project_id
             UNION
             SELECT a.user_id, a.user_name, b.project_id, b.project_name,
